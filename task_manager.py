...
user_read1 = user_read.replace(","," ")
split = user_read1.split()
username = split[0]
password = split[1]
...
: ''').lower()
    ...
    if menu == 'r':            # if "r" is chosen then the following should happen
        ...
        def add_task():
            ...
            current_date = input("Whats the current date: ")
            tasks.write(f", {current_date}")
            taskCompleted = input("Is task completed: ")
        ...
        def view_mine():
            ...
            completedTask = input("Is the task completed? ").lower
        ...
        work = input("Is work complete: ").lower()
